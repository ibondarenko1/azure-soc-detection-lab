...
Visual evidence for the lab. Full unredacted captures are staged in `_raw/` (git-ignored); the cropped copies here (browser chrome removed) are the ones referenced by the docs.
